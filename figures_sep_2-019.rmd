...
# remove CB and CS
sample_table <- sample_table[!str_detect(rownames(sample_table),"CB|CS16"),]
...
big_counts <- big_counts[,rownames(sample_table)]

## remove zero expression genes and use common gene names
# big_counts <- big_counts[rowSums(big_counts) > 0,]
# my_colnames <- colnames(big_counts)
...
### UMAP doesn't work with this few samples
